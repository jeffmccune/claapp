...
* Update the connection parameters for the database in the `claapp.db.schema` namespace of your application.
...
Request middleware functions are located under the `claapp.middleware` namespace.
